...
In this case, a regular implementation of one hot encoding (for example in the library vtreat) would not work for this data (each champion would get encoded for each column it appeared in). 
